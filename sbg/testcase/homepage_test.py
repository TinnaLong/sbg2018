...
class HomepageTest(unittest.TestCase):
    ...
    def test_homepage(self):
        ...
        self.assertText("MEN'S SUNGLASSES")

        self.move_to(driver.find_element_by_link_text("SUNGLASSES"))
        driver.find_element_by_link_text("Women").click()
        self.assertTitle("Women's Sunglasses | Buy Online at SmartBuyGlasses USA")
        self.assertText("Women'S SUNGLASSES")

        self.move_to(driver.find_element_by_link_text("SUNGLASSES"))
        driver.find_element_by_link_text("Aviator").click()
        self.assertTitle("Aviator's Sunglasses | Buy Online at SmartBuyGlasses USA")
        self.assertText("Aviator'S SUNGLASSES")
    ...
    def assertText(self, text):
        try:
            self.assertEqual(text, self.driver.find_element_by_id("HTagcontent").text)
        except AssertionError as e:
            self.verificationErrors.append(str(e))
